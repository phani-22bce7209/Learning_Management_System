    ...
    <div>
        ...
        >
          <div className='lgnd1' style={{ height: "95vh", width: "70%" }}>
            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", height: "60px", justifyContent: "space-evenly" }}>
              <select onChange={(e) => setTeachingExp(e.target.value)} style={{ width: "50%", height: 40,border:validation===true&teachingExp===""?"1px solid red":"1px solid #0a98e2" }}>
            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "row", alignItems: "center", height: "60px", justifyContent: "space-between", }}>
              <select onChange={(e) => setDay(e.target.value)} style={{ width: "25%", height: 40, border:validation===true&day===""?"1px solid red":"1px solid #0a98e2"}}>
              ...
              <input onChange={(e) => setFrom(e.target.value)} style={{ width: "25%", height: 40,border:validation===true&from===""?"1px solid red":"1px solid #0a98e2" }} type="time"></input>
              <input onChange={(e) => setTo(e.target.value)} style={{ width: "25%", height: 40,border:validation===true&to===""?"1px solid red":"1px solid #0a98e2" }} type="time"></input>
            ...
            <br />
            <button onClick={() => { postTeachersData() }} style={{ width: "100%", height: 40, borderRadius: 5, color: "white", backgroundColor: "#9edc57", border: "none" }}>Create Account</button><br /><br />
